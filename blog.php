    ...
    <div class="page-wrapper">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="footer__widget" data-aos="fade-up" data-aos-duration="1200">
                            ...
                            <div class="footer__widget-content">
                                <p class="text-justify">Bridgehouse is a performance-focused marketing company that
                                    helps
                                    businesses across industries grow through powerful strategies, lead generation, and
                                    smart
                                    digital campaigns.</p>
                            </div>
                        </div>
                        ...
                        <div class="footer__widget" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
                            ...
                            <div class="footer__widget-content">
                                <ul class="footer__contact-list">
                                    ...
                                    <li><a href="tel:9919487700"><i class="fa-solid fa-phone-flip"></i>+91
                                            9919487700</a>
                                    </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6">
                            <div class="footer__bottom-right text-lg-end">
                                <p style="text-align:center">Copyright © 2025 Bridge House, All Rights Reserved.<a
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="footer__bottom-left">
                                <ul class="footer__bottom-list  justify-content-lg-start">
                                    <li class="text-right"><a href="http://auctech.in/" target="_blank">Design and
                                            Developed by
                                            <span class="text-warning" style="font-weight: 600;">Auctech Marcom</span>
                                        </a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sticky-footer res-dd-none">
            ...
            <a href="https://wa.me/9919487700" class="phone-link" target="_blank">
                <img width="25" height="25" src="https://img.icons8.com/glyph-neue/004f8a/whatsapp.png"
                    alt="whatsapp" /> +91
                99194 87700
            </a>
