<?php
include('db_con.php');
$result = mysqli_query($con, "SELECT * FROM add_testimonial");
?>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="about__content">
                     ...
                     <div class="about__content-inner">
                        <p class="text-justify">
                           Bridgehouse is a performance-driven marketing company that works across a wide range of
                           sectors and services. From real estate to software, consumer products, and professional
                           services, we specialize in helping businesses grow through powerful, result-oriented
                           marketing strategies.
                        </p>
                        <p class="text-justify">
                           Our unique model involves running our own ads for different vendors and delivering qualified
                           leads that turn into customers. We believe in performance, not just promises.
                        </p>
                        <div class="about__content-single mt-4" data-aos="fade-up" data-aos-duration="1200">
                           <div class="thumb">
                              <i> <img width="100" height="100" src="https://img.icons8.com/comic/100/1A1A1A/goal.png"
                                    alt="goal" /></i>
                           </div>
                           <div class="content">
                        ...
                        <div class="about__content-single mt-4" data-aos="fade-up" data-aos-duration="1200">
                           <div class="thumb">
                              <i><img width="100" height="100"
                                    src="https://img.icons8.com/external-others-pike-picture/100/1A1A1A/external-Universal-Expert-expert-others-pike-picture-2.png"
                                    alt="" /></i>
                           </div>
                           <div class="content">
            ...
            <div class="row vertical-column-gap">
               ...
               <div class="col-12 col-xl-6">
                  <div class="who__content">
                     ...
                     <div class="about__content-inner">
                        <p>Bridge House is a results-driven marketing agency that partners with businesses to fuel
                           growth through strategic, lead-focused campaigns. With expertise across industries like real
                           estate, tech, and consumer services, we turn marketing into measurable success.
                        </p>
                        ...
                        <p>Bridge House helps brands connect with the right audience through smart, conversion-focused
                           marketing. Our approach is simple — performance over promises, always. Whether you're in real
                           estate, software, or services, we deliver campaigns that drive growth and visibility.
                        </p>
                        <div class="cta">
                     ...
                     <div class="row vertical-column-gap-lg">
                        <div class="col-12 col-md-6 col-xl-3">
                           <div class="procedure__single" data-aos="fade-up" data-aos-duration="1200">
                              <div class="thumb">
                                 ...
                                 <i><img width="80" height="80"
                                       src="https://img.icons8.com/dotty/80/1A1A1A/stocks-growth.png" alt="" /></i>
                              </div>
                              <div class="content">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                           <div class="procedure__single procedure__single-alter" data-aos="fade-up"
                              ...
                              <div class="thumb">
                                 <i><img width="80" height="80"
                                       src="https://img.icons8.com/ios/1A1A1A/development-skill.png" alt="" /></i>
                              </div>
                              <div class="content">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                           <div class="procedure__single procedure__single-alter" data-aos="fade-up"
                              ...
                              <div class="thumb">
                                 <i><img width="80" height="80"
                                       src="https://img.icons8.com/ios-filled/1A1A1A/conference.png" alt="" /></i>
                              </div>
                              <div class="content">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                           <div class="procedure__single" data-aos="fade-up" data-aos-duration="1200"
                              ...
                              <div class="thumb">
                                 <i> <img width="80" height="80"
                                       src="https://img.icons8.com/external-anggara-basic-outline-anggara-putra/1A1A1A/external-shield-user-interface-anggara-basic-outline-anggara-putra-3.png"
                                       alt="" /></i>
                              </div>
                              <div class="content">
                     ...
                     <div class="row vertical-column-gap-lg">
                                       ...
                                       <div class="testimonial-slider__single">
                                          <div class="author">
                                             <div class="author-thumb">
                                                <img src="admin/<?php echo $row['image_path']; ?>" alt="Image">
                                             </div>
                        ...
                        <div class="col-12 col-xl-2">
                           <div class="testimonial-navigation slider-navigation-two">
                              <button type="button" aria-label="prev slide" title="prev slide" class="prev-testimonial">
