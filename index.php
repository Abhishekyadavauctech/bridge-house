               ...
               { ?>
                  <div class="swiper-slide" style="height: 80vh;">
                     <div class="banner__slider-single" style="height: 100%;">
                        <div class="banner__slider-inner" data-background="admin/<?php echo $row['image_path']; ?>"
                           style="height: 100%; background-position: center; background-size: cover;"></div>
                        <div class="container">
                              ...
                              <div class="col-12 col-lg-10 col-xl-8">
                                 <div class="banner__slider-content">
                                    ...
                                    <div class="banner__slider-cta">
                                       <a href="about-us.php" class="btn--primary">About Us</a>
